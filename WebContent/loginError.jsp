  ...
  <div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
      ...
      <div class="col-md-10 mx-auto col-lg-5">
        <form class="p-4 p-md-5 border rounded-3 bg-light" action ="authentifier.Login" method ="post">
          <legend class ="error">
		 <img class ="" src="icons/exclamation-triangle-fill.svg" width="20" height="20">
		 Erreur de Connexion!!!!
		 </legend>
